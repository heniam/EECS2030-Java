...
public class RPSView extends JFrame {
	...
	private void makeLabels() {
		...
		this.winner.setMaximumSize(maxdim);
		...
		this.getContentPane().add(this.record);
		this.record.setMaximumSize(maxdim);
	...
	private void makeButtons(ActionListener listener) {
		...
		this.getContentPane().add(this.rock);
		this.rock.setMaximumSize(maxdim);
		this.rock.setActionCommand("ROCK");
		this.rock.addActionListener(listener);

		this.paper = new JButton("PAPER");
		this.getContentPane().add(this.paper);
		this.paper.setMaximumSize(maxdim);
		this.paper.setActionCommand("PAPER");
		this.paper.addActionListener(listener);

		this.scissors = new JButton("SCISSORS");
		this.getContentPane().add(this.scissors);
		this.scissors.setMaximumSize(maxdim);
		this.scissors.setActionCommand("SCISSORS");
	...
	public void setRecord(int gamesWon, int gamesLost, int gamesDrawn) {
		String result = String.format(
				"Games won: " + gamesWon + "," + " Games lost: " + gamesLost + "," + " Games drawn: " + gamesDrawn);
		this.record.setText(result);
	}
